                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: StreamBuilder<List<ProjectTypeRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ProjectTypeRecord>
                                    nameProjectTypeRecordList = snapshot.data!;

                                return FlutterFlowDropDown<String>(
                                  controller: _model.nameValueController ??=
                                      FormFieldController<String>(null),
                                  options: nameProjectTypeRecordList
                                      .map((e) => e.name)
                                      .toList(),
                                  onChanged: (val) =>
                                      setState(() => _model.nameValue = val),
                                  width: 300.0,
                                  height: 56.0,
                ...
                Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: StreamBuilder<List<MethodologyRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<MethodologyRecord>
                              dropDownMethodologyRecordList = snapshot.data!;

                          return FlutterFlowDropDown<String>(
                            controller: _model.dropDownValueController ??=
                                FormFieldController<String>(null),
                            options: dropDownMethodologyRecordList
                                .map((e) => e.name)
                                .toList(),
                            onChanged: (val) =>
