      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : HomeWidget(
                  filtredList: params.getParam<DocumentReference>(
                    'filtredList',
        ...
        FFRoute(
          ...
          path: '/details',
          asyncParams: {
            'currentProject': getDoc(['Project'], ProjectRecord.fromSnapshot),
          },
          builder: (context, params) => DetailsWidget(
            currentProject: params.getParam(
              'currentProject',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: 'EmptyScreen',
          path: '/emptyScreen',
          builder: (context, params) => EmptyScreenWidget(),
        ),
        FFRoute(
          name: 'HelpandSupport',
          path: '/helpandSupport',
        ...
        FFRoute(
          name: 'KYC2',
          path: '/kyc2',
          builder: (context, params) => Kyc2Widget(
            fullname: params.getParam(
              'fullname',
              ParamType.String,
            ),
            documentnumber: params.getParam(
              'documentnumber',
              ParamType.int,
            ),
        ...
        FFRoute(
          ...
          path: '/addACU',
          asyncParams: {
            'project': getDoc(['Project'], ProjectRecord.fromSnapshot),
          },
          builder: (context, params) => AddACUWidget(
