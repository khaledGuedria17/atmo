                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'jlue4vm5' /* Gain in visibility by boosting... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                                ...
                                                await showDialog(
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      title: Text('Fail'),
                                                      content: Text(
                                                          'Project has to be validated before creating your NFT.'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
                                                            ...
                                                            children: [
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        '${listViewProjectRecord.issuedACU.toString()} ACU',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodySmall
                                                                            .override(
                                                                              fontFamily: 'Plus Jakarta Sans',
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        '${listViewProjectRecord.price.toString()} APT',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodySmall
                                                                            .override(
                                                                              fontFamily: 'Plus Jakarta Sans',
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  Flexible(
                                                                    child: Text(
                                                                      'Verra ID - ${listViewProjectRecord.verraId}',
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .titleMedium
                                                                          .override(
                                                                  ...
                                                                  Flexible(
                                                                    child: Text(
                                                                      FFLocalizations.of(
                                                                              context)
                                                                          .getText(
                                                                        '5sipqv27' /* Tap to create your NFT */,
                                                                      ),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .titleMedium
